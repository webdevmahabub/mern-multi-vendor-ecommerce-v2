...
const SellerToCustomer = () => {
    ...
    const { customers, loading, error } = useSelector(state => state.chat);
    ...
    const renderCustomerList = () => {
        ...
        if (!customers || customers.length === 0) {
            return <div className="text-center text-white p-4">No customers found</div>;
        }
        ...
        return customers.map((c, i) => (
            <Link 
                ...
                className='h-[60px] flex justify-start gap-2 items-center text-white px-2 py-2 rounded-md cursor-pointer hover:bg-[#8288ed]'
            >
                                ...
                                <div className='w-full flex justify-end items-center'>
                                    <div className='flex justify-start items-start gap-2 md:px-3 py-2 max-w-full lg:max-w-[85%]'>
                                        <div className='flex justify-center items-start flex-col w-full bg-red-500 shadow-lg shadow-red-500/50 text-white py-1 px-2 rounded-sm'>
                                            <span>I'm doing well, thank you!</span>
                                        </div>
                                        <div>
                                            <img 
                                                className='w-[38px] h-[38px] border-2 border-white rounded-full max-w-[38px] p-[3px]' 
